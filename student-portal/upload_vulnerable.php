...
/**
 * upload.php — BASELINE
 * Includes a "fetch document from URL" convenience feature that performs an
 * unrestricted server-side HTTP request (Task 1 threat T6, SSRF). Hardened in
 * Task 3 with an allowlist and blocking of loopback/private/metadata ranges.
 */
