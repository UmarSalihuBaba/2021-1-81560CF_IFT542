<?php
/**
 * tests/task2_tests.php
 *
 * Run from the command line on the machine hosting the app:
 *   php tests/task2_tests.php
 *
 * Assumes the app is reachable at http://localhost/studentreg/ and the
 * database has been seeded (db/schema.sql, db/seed.sql, db/schema_update_task2.sql).
 *
 * This produces console output suitable for pasting into the "Authentication-
 * control configuration and test results" evidence section of the report.
 */
