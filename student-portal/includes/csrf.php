 ...
 * constant-time comparison. Call this before processing any state-changing
 * POST request.
 */
 ...
 * aborts with 403 if it is missing or wrong. Call at the top of any POST
 * handler for a state-changing action.
 */
